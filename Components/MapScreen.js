        ...
        {markers.map((marker) => (
          <Marker key={marker.key} coordinate={marker.coordinate} title={marker.title} description={marker.description}>
            <Callout>
              ...
              <Button title="Add to favorites" onPress={() => addToFavorites(marker)} />
            </Callout>
          </Marker>
        ))}
      </MapView>
      <View style={styles.sliderContainer}>
        <Slider style={styles.slider} minimumValue={1000} maximumValue={100000} step={1000} value={radius} onValueChange={(value) => setRadius(value)} />
      </View>
